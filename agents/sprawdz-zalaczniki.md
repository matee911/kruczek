---
name: sprawdz-zalaczniki
description: Sprawdza mechanicznie spójność gotowego pisma i załączników — numeracja, nazwy, odesłania w treści, sumy kontrolne, wymogi druku. Użyj proaktywnie po każdym złożeniu PDF, zanim pismo trafi do użytkownika.
...
1. **Czy załączniki się nie ucięły** — `pdftotext -f <od> -l <do> <pismo.pdf> -` na stronach załączników; szukaj
...
**🔴 BLOKUJE WYSYŁKĘ** — co, w którym pliku, i gotowa propozycja poprawki.

**🟠 OSTRZEŻENIE** — co konkretnie i gdzie.

Przy błędach jednoznacznie mechanicznych (literówka w nazwie pliku, brakujący wpis na liście
załączników, nieaktualna suma kontrolna) — popraw sam i zaznacz co zmieniłeś. Wszystko, co
dotyka treści merytorycznej — zgłaszasz i zostawiasz.
