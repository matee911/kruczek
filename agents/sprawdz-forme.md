...
| Podpis zaufany (Profil Zaufany) | równoważny własnoręcznemu **wobec podmiotów publicznych**; wobec dostawcy telekom — wyłącznie przy potwierdzeniu danych abonenta (art. 296 ust. 3 pkt 2 lit. e Pke) i za zgodą obu stron, nie jako podpis pod umową | art. 20ae ust. 2 i 2a w zw. z art. 2 ust. 1 ustawy o informatyzacji. **Nie jest formą elektroniczną z art. 78¹ k.c.** (ta wymaga QES) — w obrocie prywatnym traktuj jako najwyżej dokumentową |
